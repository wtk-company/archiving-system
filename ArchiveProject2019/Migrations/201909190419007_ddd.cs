    ...
    public partial class ddd : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        ConcernedParty_Id = c.Int(),
                        DocumentKind_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AspNetUsers", t => t.CreatedById)
                .ForeignKey("dbo.Departments", t => t.DepartmentId, cascadeDelete: true)
                .ForeignKey("dbo.Forms", t => t.FormId, cascadeDelete: true)
                .ForeignKey("dbo.ConcernedParties", t => t.ConcernedParty_Id)
                .ForeignKey("dbo.DocumentKinds", t => t.DocumentKind_Id)
                .Index(t => t.CreatedById)
                .Index(t => t.DepartmentId)
                .Index(t => t.FormId)
                .Index(t => t.ConcernedParty_Id)
                .Index(t => t.DocumentKind_Id);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AspNetUsers", t => t.CreatedById)
                .ForeignKey("dbo.Documents", t => t.Docuemnt_Id)
                .ForeignKey("dbo.Fields", t => t.FieldId, cascadeDelete: true)
                .Index(t => t.CreatedById)
                .Index(t => t.FieldId)
                .Index(t => t.Docuemnt_Id);
